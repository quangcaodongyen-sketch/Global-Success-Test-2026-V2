    ...
    <div className="space-y-10 pb-12">
      ...
      <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-950 via-blue-950 to-indigo-950 text-white p-8 sm:p-12 shadow-2xl border border-blue-800/40">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center space-y-6">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-500/20 border border-blue-400/30 text-blue-300 text-xs font-black uppercase tracking-wider animate-pulse">
            ...
            <span>GIẢI PHÁP KHẢO THÍ SỐ TOÀN DIỆN CHO GIÁO VIÊN TIẾNG ANH THCS</span>
          </div>
          ...
          <p className="text-sm sm:text-base text-blue-100 max-w-3xl mx-auto leading-relaxed font-normal">
            Ứng dụng độc quyền của <strong className="text-amber-300 font-bold">Thầy giáo Đinh Văn Thành</strong> (Trường THCS Đồng Yên, tỉnh Tuyên Quang). Giúp quý Thầy/Cô loại bỏ hoàn toàn nỗi ám ảnh kẻ bảng ma trận 15 cột, làm bản đặc tả 7 cột, chia điểm thủ công và gõ lại từng mã đề.
          </p>
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          <div className="p-6 bg-white rounded-3xl border border-slate-200/90 shadow-sm hover:shadow-md transition-all space-y-3 group hover:border-blue-300">
            ...
            <p className="text-xs text-slate-600 leading-relaxed">
              Kết hợp hoàn hảo giữa <strong>20 bộ đề chuẩn gốc 53KB</strong> do trường THCS Đồng Yên phê duyệt và <strong>Cỗ máy AI 48 Units</strong> với kho từ vựng khổng lồ, sinh đề ngẫu nhiên không bao giờ trùng lặp.
            </p>
          </div>
          ...
          <div className="p-6 bg-white rounded-3xl border border-slate-200/90 shadow-sm hover:shadow-md transition-all space-y-3 group hover:border-blue-300">
            ...
            <h3 className="text-base font-black text-slate-900">6. Tặng 04 Đề Cương 6 Trang Mục Tiêu 6.0+</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
              Bộ tài liệu ôn tập trọng tâm 6 trang cho cả 4 khối (6, 7, 8, 9). Giúp Thầy Cô có sẵn giáo án phụ đạo học sinh yếu kém, nâng cao phổ điểm khảo sát và chất lượng đại trà môn Tiếng Anh.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="p-8 bg-gradient-to-br from-indigo-50/80 via-blue-50/50 to-white rounded-3xl border border-indigo-100 shadow-sm space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-5 bg-white rounded-2xl border border-indigo-100 shadow-sm space-y-2 relative">
            ...
            <h3 className="font-extrabold text-sm text-slate-800">Chọn Khối Lớp & Kỳ Thi</h3>
            <p className="text-xs text-slate-500 leading-relaxed">
              Chọn Lớp 6, 7, 8 hoặc 9. Chọn kỳ Giữa kỳ, Cuối kỳ, Khảo sát chất lượng hoặc Đề cương ôn tập 6 trang.
            </p>
          </div>
          ...
          <div className="p-5 bg-white rounded-2xl border border-indigo-100 shadow-sm space-y-2 relative">
            ...
            <h3 className="font-extrabold text-sm text-slate-800">Điền Tên Trường & Cơ Quan</h3>
            <p className="text-xs text-slate-500 leading-relaxed">
              Nhập tên Phòng GD&ĐT và Trường THCS của Thầy/Cô. Hệ thống tự động ghi nhớ cho các lần sử dụng sau.
            </p>
          </div>
      ...
      <section className="p-8 bg-white rounded-3xl border border-slate-200/90 shadow-sm space-y-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 pb-4 border-b border-slate-100">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">
              Giáo viên Trường THCS Đồng Yên, tỉnh Tuyên Quang • Hotline/Zalo: <strong>0915.213.717</strong>
            </p>
          </div>
        </div>
        ...
        <div className="text-xs sm:text-sm text-slate-700 leading-relaxed space-y-3 font-normal">
          ...
          <p>
            Là một giáo viên trực tiếp đứng lớp giảng dạy bộ môn Tiếng Anh THCS nhiều năm qua, tôi thấu hiểu sâu sắc áp lực và sự vất vả của các Thầy Cô mỗi khi bước vào mùa kiểm tra giữa kỳ, cuối kỳ. Việc phải vừa giảng dạy, vừa soạn đề thi, vừa cân đối ma trận 15 cột, vừa viết bản đặc tả kỹ thuật chi tiết theo đúng tinh thần Công văn 7991 chiếm dụng rất nhiều thời gian nghỉ ngơi quý báu của Thầy Cô.
          </p>
          <p>
